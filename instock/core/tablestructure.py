...
TABLE_CN_ETF_SPOT = {'name': 'cn_etf_spot', 'cn': '每日ETF数据',
                     'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                 ...
                                 'change_rate': {'type': FLOAT, 'cn': '涨跌幅(%)', 'size': 85},
                                 'ups_downs': {'type': FLOAT, 'cn': '涨跌额', 'size': 70},
                                 'volume': {'type': BIGINT, 'cn': '成交量(手)', 'size': 100},
                                 ...
                                 'turnoverrate': {'type': FLOAT, 'cn': '换手率(%)', 'size': 90},
...
TABLE_CN_STOCK_SPOT = {'name': 'cn_stock_spot', 'cn': '每日股票数据',
                       'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                   ...
                                   'pre_close_price': {'type': FLOAT, 'cn': '昨收', 'size': 70},
                                   'speed_increase': {'type': FLOAT, 'cn': '涨速(%)', 'size': 80},
                                   'speed_increase_5': {'type': FLOAT, 'cn': '5分钟涨跌(%)', 'size': 95},
                                   'speed_increase_60': {'type': FLOAT, 'cn': '60日涨跌幅(%)', 'size': 105},
                                   'speed_increase_all': {'type': FLOAT, 'cn': '年初至今涨跌幅(%)', 'size': 120},
                                   ...
                                   'roe_weight': {'type': FLOAT, 'cn': '加权净资产收益率(%)', 'size': 120},
                                   'sale_gpr': {'type': FLOAT, 'cn': '毛利率(%)', 'size': 85},
                                   'debt_asset_ratio': {'type': FLOAT, 'cn': '资产负债率(%)', 'size': 100},
                                   'total_operate_income': {'type': BIGINT, 'cn': '营业收入', 'size': 120},
                                   'toi_yoy_ratio': {'type': FLOAT, 'cn': '营业收入同比增长(%)', 'size': 120},
                                   'parent_netprofit': {'type': BIGINT, 'cn': '归属净利润', 'size': 110},
                                   'netprofit_yoy_ratio': {'type': FLOAT, 'cn': '归属净利润同比增长(%)', 'size': 130},
...
TABLE_CN_STOCK_BONUS = {'name': 'cn_stock_bonus', 'cn': '股票分红配送',
                        'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                    'code': {'type': VARCHAR(6, _COLLATE), 'cn': '代码', 'size': 60},
                                    'name': {'type': VARCHAR(20, _COLLATE), 'cn': '名称', 'size': 70},
                                    'convertible_total_rate': {'type': FLOAT, 'cn': '送转股份-送转总比例(%)', 'size': 120},
                                    'convertible_rate': {'type': FLOAT, 'cn': '送转股份-送转比例(%)', 'size': 115},
                                    'convertible_transfer_rate': {'type': FLOAT, 'cn': '送转股份-转股比例(%)', 'size': 115},
                                    'bonusaward_rate': {'type': FLOAT, 'cn': '现金分红-现金分红比例(%)', 'size': 130},
                                    'bonusaward_yield': {'type': FLOAT, 'cn': '现金分红-股息率(%)', 'size': 115},
                                    'basic_eps': {'type': FLOAT, 'cn': '每股收益', 'size': 70},
                                    'bvps': {'type': FLOAT, 'cn': '每股净资产', 'size': 70},
                                    'per_capital_reserve': {'type': FLOAT, 'cn': '每股公积金', 'size': 70},
                                    'per_unassign_profit': {'type': FLOAT, 'cn': '每股未分配利润', 'size': 70},
                                    'netprofit_yoy_ratio': {'type': FLOAT, 'cn': '净利润同比增长(%)', 'size': 115},
                                    'total_shares': {'type': BIGINT, 'cn': '总股本', 'size': 120},
...
TABLE_CN_STOCK_TOP = {'name': 'cn_stock_top', 'cn': '股票龙虎榜(新浪)',
                      'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                  'code': {'type': VARCHAR(6, _COLLATE), 'cn': '代码', 'size': 60},
                                  'name': {'type': VARCHAR(20, _COLLATE), 'cn': '名称', 'size': 70},
                                  'ranking_times': {'type': FLOAT, 'cn': '上榜次数(次)', 'size': 90},
...
TABLE_CN_STOCK_LHB = {'name': 'cn_stock_lhb', 'cn': '股票龙虎榜',
                      'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                  ...
                                  'net_amount_rate': {'type': FLOAT, 'cn': '净买额占总成交比(%)', 'size': 130},
                                  'sum_rate': {'type': FLOAT, 'cn': '成交额占总成交比(%)', 'size': 130},
                                  'turnoverrate': {'type': FLOAT, 'cn': '换手率(%)', 'size': 90},
                                  'free_cap': {'type': BIGINT, 'cn': '流通市值', 'size': 120},
                                  'reason': {'type': VARCHAR(2000, _COLLATE), 'cn': '上榜原因', 'size': 150},
                                  'ranking_after_1': {'type': FLOAT, 'cn': '上榜后1日涨跌幅(%)', 'size': 120},
                                  'ranking_after_2': {'type': FLOAT, 'cn': '上榜后2日涨跌幅(%)', 'size': 120},
                                  'ranking_after_5': {'type': FLOAT, 'cn': '上榜后5日涨跌幅(%)', 'size': 120},
                                  'ranking_after_10': {'type': FLOAT, 'cn': '上榜后10日涨跌幅(%)', 'size': 125}}}
...
TABLE_CN_STOCK_BLOCKTRADE = {'name': 'cn_stock_blocktrade', 'cn': '股票大宗交易',
                             'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                         ...
                                         'overflow_rate': {'type': FLOAT, 'cn': '折溢率(%)', 'size': 130},
                                         'trade_number': {'type': FLOAT, 'cn': '成交笔数(笔)', 'size': 90},
                                         'sum_volume': {'type': FLOAT, 'cn': '成交总量(股)', 'size': 110},
